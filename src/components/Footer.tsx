...
import { FOOTER_LINKS, SOCIAL_LINKS, SITE } from '@/utils/constants';
...
export function Footer() {
  ...
  Empowering businesses with intelligent AI automation, seamless collaboration,
  and secure cloud solutions to improve productivity and drive growth.
</p>
              ...
              {SOCIAL_LINKS.map((s) => (
                <li key={s.label}>
                  <a
                    ...
                    className="flex h-9 w-9 items-center justify-center rounded-full bg-ink-100 text-ink-600 hover:bg-ink-900 hover:text-white transition-colors"
